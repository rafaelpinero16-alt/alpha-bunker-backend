window.t = {
    es: { 
        ...
        rank_name_0: "SPY", rank_name_1: "SOLDIER", rank_name_2: "VETERAN", rank_name_3: "LEGEND", rank_name_4: "ICON LEGEND",
        ...
        pkg_spy_name: "SPY", pkg_spy_desc: "Acceso a contenido público y general del Búnker. Permiso de chat global sujeto a consumo de tokens ($ALPHA).", pkg_soldier_name: "SOLDIER", pkg_soldier_desc: "Acceso a publicaciones exclusivas de Nivel 1, permiso para etiquetar (@) en el chat global y soporte prioritario.", pkg_veteran_name: "VETERAN", pkg_veteran_desc: "Acceso a contenido táctico avanzado y permiso para enviar fotografías directamente en el Chat Global.", pkg_legend_name: "LEGEND", pkg_legend_desc: "Estatus de Comandante, acceso a material de alto nivel y permiso para transmitir o enviar videos cortos en el chat.", pkg_icon_legend_name: "ICON LEGEND", pkg_icon_legend_desc: "Acceso total e ilimitado a todo el ecosistema, cámaras, transmisiones del Video Búnker y privilegios máximos en la plataforma.",
    ...
    en: { 
        ...
        pkg_spy_name: "SPY", pkg_spy_desc: "Access to public and general Bunker content. Global chat permission subject to token consumption ($ALPHA).", pkg_soldier_name: "SOLDIER", pkg_soldier_desc: "Access to Level 1 exclusive posts, permission to tag (@) in global chat, and priority support.", pkg_veteran_name: "VETERAN", pkg_veteran_desc: "Access to advanced tactical content and permission to send photos directly in Global Chat.", pkg_legend_name: "LEGEND", pkg_legend_desc: "Commander status, access to high-level material, and permission to stream or send short videos in chat.", pkg_icon_legend_name: "ICON LEGEND", pkg_icon_legend_desc: "Total and unlimited access to the entire ecosystem, cameras, Video Bunker streams, and maximum platform privileges.",
    ...
    it: { 
        ...
        pkg_spy_name: "SPY", pkg_spy_desc: "Accesso ai contenuti pubblici e generali del Bunker. Permesso di chat globale soggetto a consumo di token ($ALPHA).", pkg_soldier_name: "SOLDIER", pkg_soldier_desc: "Accesso a post esclusivi di Livello 1, permesso di taggare (@) nella chat globale e supporto prioritario.", pkg_veteran_name: "VETERAN", pkg_veteran_desc: "Accesso a contenuti tattici avanzati e permesso di inviare foto direttamente nella Chat Globale.", pkg_legend_name: "LEGEND", pkg_legend_desc: "Status di Comandante, accesso a materiale di alto livello e permesso di trasmettere o inviare brevi video nella chat.", pkg_icon_legend_name: "ICON LEGEND", pkg_icon_legend_desc: "Accesso totale e illimitato all'intero ecosistema, telecamere, trasmissioni Video Bunker e massimi privilegi sulla piattaforma.",
    ...
    pt: { 
        ...
        pkg_spy_name: "SPY", pkg_spy_desc: "Acesso a conteúdo público e geral do Búnker. Permissão de chat global sujeita ao consumo de tokens ($ALPHA).", pkg_soldier_name: "SOLDIER", pkg_soldier_desc: "Acesso a postagens exclusivas de Nível 1, permissão para marcar (@) no chat global e suporte prioritário.", pkg_veteran_name: "VETERAN", pkg_veteran_desc: "Acesso a conteúdo tático avançado e permissão para enviar fotos diretamente no Chat Global.", pkg_legend_name: "LEGEND", pkg_legend_desc: "Status de Comandante, acesso a material de alto nível e permissão para transmitir ou enviar vídeos curtos no chat.", pkg_icon_legend_name: "ICON LEGEND", pkg_icon_legend_desc: "Acesso total e ilimitado a todo o ecossistema, câmeras, transmissões do Vídeo Búnker e privilégios máximos na plataforma.",
        btn_sel: "SELECIONAR", btn_life: "SELECIONAR B2B", btn_bank: "Bancos e Stripe", com_title: "PARCEIROS", pay_stars: "Telegram Stars", btn_stripe: "Stripe / Checkout Externo", txt_pay_proof: "Enviar comprovante ao CRM.", bank_title: "BANCOS", copy_global: "Copiar Dados", copy_airtm: "Copiar Dados", copy_ton: "Copiar Endereço",
    ...
    de: { 
        ...
        pkg_spy_name: "SPY", pkg_spy_desc: "Zugang zu öffentlichen und allgemeinen Bunker-Inhalten. Globale Chat-Berechtigung vorbehaltlich des Token-Verbrauchs ($ALPHA).", pkg_soldier_name: "SOLDIER", pkg_soldier_desc: "Zugang zu exklusiven Beiträgen der Stufe 1, Berechtigung zum Markieren (@) im globalen Chat und priorisierter Support.", pkg_veteran_name: "VETERAN", pkg_veteran_desc: "Zugang zu fortgeschrittenen taktischen Inhalten und Berechtigung, Fotos direkt im globalen Chat zu senden.", pkg_legend_name: "LEGEND", pkg_legend_desc: "Kommandantenstatus, Zugang zu hochrangigem Material und Berechtigung zum Streamen oder Senden von Kurzvideos im Chat.", pkg_icon_legend_name: "ICON LEGEND", pkg_icon_legend_desc: "Völliger und unbegrenzter Zugang zum gesamten Ökosystem, Kameras, Video-Bunker-Streams und maximale Plattformprivilegien.",
    ...
    fr: { 
        ...
        pkg_spy_name: "SPY", pkg_spy_desc: "Accès au contenu public et général du Bunker. Autorisation de chat global soumise à la consommation de jetons ($ALPHA).", pkg_soldier_name: "SOLDIER", pkg_soldier_desc: "Accès aux publications exclusives de Niveau 1, autorisation d'identifier (@) dans le chat global et support prioritaire.", pkg_veteran_name: "VETERAN", pkg_veteran_desc: "Accès au contenu tactique avancé et autorisation d'envoyer des photos directement dans le Chat Global.", pkg_legend_name: "LEGEND", pkg_legend_desc: "Statut de Commandant, accès à du matériel de haut niveau et autorisation de diffuser ou d'envoyer de courtes vidéos dans le chat.", pkg_icon_legend_name: "ICON LEGEND", pkg_icon_legend_desc: "Accès total et illimité à l'ensemble de l'écosystème, aux caméras, aux flux du Bunker Vidéo et privilèges maximaux sur la plateforme.",
