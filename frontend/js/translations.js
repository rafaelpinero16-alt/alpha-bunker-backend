const t = {
    ...
    en: { 
        ...
        prof_title: "MY PROFILE", prof_alpha_title: "$ALPHA WALLET", prof_alpha_desc: "Recharge balance with your connected TON wallet to tip and unlock exclusive content.", btn_recharge: "RECHARGE 1 TON x 100 $ALPHA", lbl_alias: "USERNAME / ALIAS", prof_growth: "Rank Growth", prof_next: "Next: SOLDIER", lbl_bio: "BIO / VIP DESCRIPTION", btn_save_bio: "SAVE PROFILE", btn_pub_content: "PUBLISH CONTENT",
        prof_kyc_title: "KYC STATUS (+18)", prof_kyc_desc: "Verify your official document and selfie to post and monetize.", btn_verify_kyc: "VERIFY ACCOUNT NOW", prof_kyc_verified: "VERIFIED (+18) ✅", prof_kyc_verified_desc: "Identity and age confirmed. Full access active.", prof_kyc_pending: "IN REVIEW ⏳", prof_kyc_pending_desc: "Your documents are being audited by Bunker Admin.", btn_kyc_pending: "REQUEST IN PROCESS ⏳",
        ...
        chat_title: "BUNKER SUPPORT (PRIVATE CRM)", chat_routed: "Direct Channel with Admin", btn_send_proof: "SEND RECEIPT TO BUNKER", chat_welcome: "Bunker CRM Active!", chat_placeholder: "Type your message...",
        wall_chat_title: "GLOBAL CHAT & VIDEO BUNKER", wall_chat_desc: "Live Community (Independent)", btn_wall_chat: "OPEN CHAT", btn_wall_video: "OPEN VIDEO",
        ...
        btn_go_live: "GO LIVE", btn_cancel_stream: "STOP", btn_close_cam: "CLOSE", stream_announce: "🔴 I've started a live stream in the Bunker! Join the broadcast.", av_settings_title: "Broadcast Settings", lbl_cam: "Camera / OBS", lbl_mic: "Microphone", btn_apply_av: "SAVE AND APPLY",
        sys_warn_spam: "⚠️ @{user}, external links are forbidden. Warning {warn}/5. Penalty: -{penalty} $ALPHA."
    },
    it: { 
        ...
        sys_warn_spam: "⚠️ @{user}, i link esterni sono vietati. Avviso {warn}/5."
    },
    pt: { 
        ...
        prof_title: "MEU PERFIL", prof_alpha_title: "CARTEIRA $ALPHA", prof_alpha_desc: "Recarregue para desbloquear conteúdo.", btn_recharge: "RECARREGAR 1 TON x 100 $ALPHA", lbl_alias: "NOME DE USUÁRIO", prof_growth: "Crescimento", prof_next: "Próximo: SOLDIER", lbl_bio: "BIO / DESCRIÇÃO", btn_save_bio: "SALVAR PERFIL", btn_pub_content: "PUBLICAR CONTEÚDO",
        ...
        btn_go_live: "TRANSMITIR", btn_cancel_stream: "PARAR", btn_close_cam: "FECHAR", stream_announce: "🔴 Iniciei uma transmissão ao vivo no Búnker! Juntem-se.", av_settings_title: "Configurações de Transmissão", lbl_cam: "Câmera / OBS", lbl_mic: "Microfone", btn_apply_av: "SALVAR E APLICAR",
        sys_warn_spam: "⚠️ @{user}, links externos são proibidos. Aviso {warn}/5."
    },
    de: { 
        ...
        sys_warn_spam: "⚠️ @{user}, externe Links sind verboten. Warnung {warn}/5."
    },
    fr: { 
        ...
        prof_title: "MON PROFIL", prof_alpha_title: "PORTEFEUILLE $ALPHA", prof_alpha_desc: "Rechargez votre solde.", btn_recharge: "RECHARGER 1 TON x 100 $ALPHA", lbl_alias: "NOM D'UTILISATEUR", prof_growth: "Croissance", prof_next: "Prochain: SOLDIER", lbl_bio: "BIO / DESCRIPTION", btn_save_bio: "SAUVEGARDER", btn_pub_content: "PUBLIER CONTENU",
        ...
        sys_warn_spam: "⚠️ @{user}, les liens externes sont interdits. Avertissement {warn}/5."
    }
};
