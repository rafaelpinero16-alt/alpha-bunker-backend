const t = {
    es: { 
        ...
        // --- TEXTOS COMPLETOS DE PERFIL (KYC y B2B) ---
        prof_kyc_title: "ESTADO KYC (+18)",
        prof_kyc_desc: "Verifica tu documento oficial y selfie para publicar y monetizar.",
        btn_verify_kyc: "VERIFICAR CUENTA AHORA",
        prof_kyc_verified: "VERIFICADO (+18) ✅",
        prof_kyc_verified_desc: "Identidad y mayoría de edad confirmada. Acceso total activo.",
        prof_kyc_pending: "EN REVISIÓN ⏳",
        prof_kyc_pending_desc: "Tus documentos están siendo auditados por el Búnker Admin.",
        btn_kyc_pending: "SOLICITUD EN PROCESO ⏳",
        
        b2b_main_title: "MEMBRESÍA CREADOR B2B",
        b2b_free_month: "1º MES GRATIS 🎁",
        b2b_desc: "Desbloquea la edición de tu Tip Menu y monetización activa.",
        b2b_soldier_title: "SOLDIER CREATOR", b2b_soldier_price: "$4.99 USD / mes",
        b2b_icon_title: "ICON CREATOR", b2b_icon_price: "$7.99 USD / mes",
        b2b_edit_tips: "EDITAR MIS 10 SLOTS (TIP MENU)",
...
window.applyTranslations = function(lang) {
    ...
    const map = {
        ...
        'nav-catalog': 'nav_cat', 'nav-communities': 'nav_com', 'nav-home': 'nav_home', 'nav-profile': 'nav_profile', 'nav-support': 'nav_sup',
